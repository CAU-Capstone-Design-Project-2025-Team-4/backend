...
public class AnimationController {
    ...
    public ApiResponse<AnimationResponse> addAnimation(@RequestBody AddAnimationRequest request) {
        Animation animation = animationService.addAnimationToElement(request.getUserId(), request.getElementId(), request.getType(), request.getDuration(), request.getTiming(), request.getCameraTransform());
